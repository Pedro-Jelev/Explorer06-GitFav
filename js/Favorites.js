...
export class FavoritesView extends Favorites {
    ...
    update() {
        ...
        const isEmpty = this.entries[0] === undefined
    ...
    createRow() {
        ...
        tr.innerHTML = `
            <td class="user">
                <img src="https://github.com/pedro-jelev.png" alt="Imagem de pedro-jelev">
    
                <a href="https://github.com/pedrojelev" target="_blank">
                    <p>Pedro-Jelev</p>
                    <span>PedroJelev</span>
                </a>
            </td>
